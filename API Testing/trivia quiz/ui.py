...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=true_button_image, highlightthickness=0, command=self.user_true)
        self.true_button.grid(row=2, column=0)

        false_button_image = PhotoImage(file='images/false.png')
        self.false_button = Button(image=false_button_image, highlightthickness=0, command=self.user_false)
